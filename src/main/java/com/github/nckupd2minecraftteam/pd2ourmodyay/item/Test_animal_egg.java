...
public class Test_animal_egg extends Item{
	public Test_animal_egg() {
    ...
    public ActionResultType onItemUse(ItemUseContext context) {
        ...
        if (world.isRemote) {
            ...
            if (tileentity instanceof MobSpawnerTileEntity) {
                ...
                abstractspawner.setEntityType(Entities.EntityRegistry.TEST_ANIMAL.get());
            ...
            if (Entities.EntityRegistry.TEST_ANIMAL.get().spawn(world, itemstack, context.getPlayer(), blockpos1, SpawnReason.SPAWN_EGG, true, true) != null) {
                itemstack.shrink(1);
            }
