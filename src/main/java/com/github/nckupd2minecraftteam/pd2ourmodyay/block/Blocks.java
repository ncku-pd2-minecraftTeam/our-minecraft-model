...
public class Blocks {
    ...
    public static class BlockRegistry{
        ...
        public static final RegistryObject<Block> OBJ_AND_GATE= BlockRegistry.REGISTER.register("and_gate", () -> new And_gate());
        public static final RegistryObject<Block> OBJ_NAND_GATE= BlockRegistry.REGISTER.register("nand_gate", () -> new NAnd_gate());
        public static final RegistryObject<Block> OBJ_XOR_GATE= BlockRegistry.REGISTER.register("xor_gate", () -> new Xor_gate());
    }
}
