...
public class Magic_silver_slime extends MobEntity implements IMob{
	...
	public Magic_silver_slime(EntityType<? extends MobEntity> type, final World worldIn) {
        super(type, worldIn);
        this.moveController = new Magic_silver_slime.MoveHelperController(this);
    }
	
	   protected void registerGoals() {
		      this.goalSelector.addGoal(1, new Magic_silver_slime.FloatGoal(this));
		      this.goalSelector.addGoal(2, new Magic_silver_slime.AttackGoal(this));
		      this.goalSelector.addGoal(3, new Magic_silver_slime.FaceRandomGoal(this));
		      this.goalSelector.addGoal(5, new Magic_silver_slime.HopGoal(this));
		   ...
		   public EntityType<? extends Magic_silver_slime> getType() {
		      return (EntityType<? extends Magic_silver_slime>) super.getType();
		   }
		   ...
		   public void remove(boolean keepData) {
		      ...
		      if (!this.world.isRemote && i > 1 && this.getHealth() <= 0.0F && !this.removed) {
		         ...
		         for(int k = 0; k < j; ++k) {
		            ...
		            Magic_silver_slime slimeentity = this.getType().create(this.world);
		   ...
		   static class AttackGoal extends Goal {
		      private final Magic_silver_slime slime;
		      private int growTieredTimer;

		      public AttackGoal(Magic_silver_slime magic_silver_slime) {
		         this.slime = magic_silver_slime;
		      ...
		      public boolean shouldExecute() {
		         ...
		         if (livingentity == null) {
		            ...
		            return livingentity instanceof PlayerEntity && ((PlayerEntity)livingentity).abilities.disableDamage ? false : this.slime.getMoveHelper() instanceof Magic_silver_slime.MoveHelperController;
		         }
		      }
		      ...
		      public void tick() {
		         ...
		         ((Magic_silver_slime.MoveHelperController)this.slime.getMoveHelper()).setDirection(this.slime.rotationYaw, this.slime.canDamagePlayer());
		      }
		   }
		   ...
		   static class FaceRandomGoal extends Goal {
		      ...
		      public FaceRandomGoal(Magic_silver_slime slimeIn) {
		         this.slime = slimeIn;
		         this.setMutexFlags(EnumSet.of(Goal.Flag.LOOK));
		      }
		       ...
		       */
		      public boolean shouldExecute() {
		         return this.slime.getAttackTarget() == null && (this.slime.onGround || this.slime.isInWater() || this.slime.isInLava() || this.slime.isPotionActive(Effects.LEVITATION)) && this.slime.getMoveHelper() instanceof Magic_silver_slime.MoveHelperController;
		      }
		      ...
		      public void tick() {
		         ...
		         ((Magic_silver_slime.MoveHelperController)this.slime.getMoveHelper()).setDirection(this.chosenDegrees, false);
		      }
		   }
		   ...
		   static class FloatGoal extends Goal {
		      ...
		      public FloatGoal(Magic_silver_slime magic_silver_slime) {
		         this.slime = magic_silver_slime;
		         this.setMutexFlags(EnumSet.of(Goal.Flag.JUMP, Goal.Flag.MOVE));
		         magic_silver_slime.getNavigator().setCanSwim(true);
		      }
		       ...
		       */
		      public boolean shouldExecute() {
		         return (this.slime.isInWater() || this.slime.isInLava()) && this.slime.getMoveHelper() instanceof Magic_silver_slime.MoveHelperController;
		      }
		      ...
		      public void tick() {
		         ...
		         ((Magic_silver_slime.MoveHelperController)this.slime.getMoveHelper()).setSpeed(1.2D);
		      }
		   }
		   ...
		   static class HopGoal extends Goal {
		      ...
		      public HopGoal(Magic_silver_slime magic_silver_slime) {
		         this.slime = magic_silver_slime;
		         this.setMutexFlags(EnumSet.of(Goal.Flag.JUMP, Goal.Flag.MOVE));
		      }
		       ...
		       */
		      public void tick() {
		         ((Magic_silver_slime.MoveHelperController)this.slime.getMoveHelper()).setSpeed(1.0D);
		      }
		   }
		   ...
		   static class MoveHelperController extends MovementController {
		      ...
		      public MoveHelperController(Magic_silver_slime slimeIn) {
		         super(slimeIn);
		         this.slime = slimeIn;
